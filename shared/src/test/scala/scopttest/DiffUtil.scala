...
object DiffUtil {
  ...
  def mkColoredDiff(expected: String, actual: String): String = {
    mkColoredLineDiff(expected.linesList, actual.linesList)
  }
   ...
   */
  def mkColoredLineDiff(expected: ISeq[String], actual: ISeq[String]): String = {
